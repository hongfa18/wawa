...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout {
	...
	final class LoadingLayout extends FrameLayout {
		...
		public LoadingLayout(Context context, final int mode, String releaseLabel, String pullLabel, String refreshingLabel) {
			...
			switch (mode) {
				case PullToRefreshBase.MODE_PULL_UP_TO_REFRESH:
					headerImage.setImageResource(R.drawable.pull_to_refresh_up_arrow);
					break;
				case PullToRefreshBase.MODE_PULL_DOWN_TO_REFRESH:
				default:
					headerImage.setImageResource(R.drawable.pull_to_refresh_down_arrow);
					break;
			}
		}
	...
	private void init(Context context, AttributeSet attrs) {
		...
		if (a.hasValue(R.styleable.PullToRefresh_pullMode)) {
			mode = a.getInteger(R.styleable.PullToRefresh_pullMode, MODE_BOTH);
		}
		...
		if (mode == MODE_PULL_UP_TO_REFRESH || mode == MODE_BOTH) {
			String pullLabel2 = context.getString(R.string.pull_to_refresh_tap_label);
			footerLayout = new LoadingLayout(context, MODE_PULL_UP_TO_REFRESH, releaseLabel, pullLabel2, refreshingLabel);
