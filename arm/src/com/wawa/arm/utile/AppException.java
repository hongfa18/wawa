 ...
 * @author W.Y
 * @version 1.0
 * @created 2014年5月22日 下午8:07:26
 */
public class AppException extends Exception implements UncaughtExceptionHandler{
	private static final long serialVersionUID = 9063741828903563238L;
	...
	private String getCrashReport(Context context, Throwable ex) {
		PackageInfo pinfo = OMApplication.getInstance().getPackageInfo();
	...
	public static void sendAppCrashReport(final Context cont,
		...
		final OMDialog dialog = OMDialog.createDialog(cont);
		dialog.setTitile(cont.getString(R.string.app_error));
		dialog.setContent(Html.fromHtml(cont.getString(R.string.app_error_message)));
		...
		dialog.setBtnOkClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				i.putExtra(Intent.EXTRA_EMAIL,
						new String[] { "wu.yong70@zte.com.cn" });
				i.putExtra(Intent.EXTRA_SUBJECT,
						"Oanger Money Android APP - Error Report");
		...
		dialog.setBtnCancelClickListener(new View.OnClickListener() {
			@Override
