...
// Md5.java
// $Id: Md5.java,v 1.13 2004/03/22 03:50:29 kevin Exp $
...
public class SMMd5
{
    ...
    public SMMd5 (String input, String enc)
    {
        byte bytes[] = null;
        try {
    ...
    public static void main (String args[]) throws IOException
    {
        ...
        SMMd5 md5 = new SMMd5 (args[0].getBytes ());
